                    ...
                    <table class="table table-striped" id="example2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <?php echo mb_strimwidth($hotel->address, 0, 40, "..."); ?> </td>
                                ...
                                <td class="text-center">
                                    <form action="{{ url('/hotel', ['id' => $hotel->id]) }}" method="post">
                                        ...
                                        <a href="{{ route('hotel.destroy', $hotel->id) }}" class="btn btn-danger btn-icons btn-rounded" onclick="notificationBeforeDelete(event, this)">
